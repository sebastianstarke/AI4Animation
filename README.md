...
It extends the recent research of Daniel Holden, Taku Komura and Jun Saito on character control using PFNN (Phase-Functioned Neural Networks), and scientifically continues their work for learning task-specific motion manifolds using multiple phases modules, and representations for different geometries. The development is done using Unity3D, and the implementation will be made available for character animation research and games development inside this engine.
