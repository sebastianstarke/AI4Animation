"""
Class of control points, i.e. alphas, betas
"""
import numpy as np
...
class ControlPoints:
    def __init__(self, rng, shape , name):
        ...
        self.weight_shape =  shape                    #4 * out * in
        self.bias_shape   =  (shape[0],shape[1],1)    #4 * out * 1
...
def save_cp(alpha, beta, filename, num_cp):
