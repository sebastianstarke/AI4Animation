...
public static class Matrix4x4Extensions {
	...
	public static Vector3 GetRootParameters(this Matrix4x4 matrix) {
		return new Vector3(matrix.GetPosition().x, matrix.GetRotation().eulerAngles.y, matrix.GetPosition().z);
	}
	...
	public static Matrix4x4 Gaussian(this Matrix4x4[] matrices) {
		return Matrix4x4.TRS(matrices.GetPositions().Gaussian(), matrices.GetRotations().Gaussian(), matrices.GetScales().Gaussian());
	}
