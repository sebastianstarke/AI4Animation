...
public class GenerativeController : NeuralAnimation {
	...
	protected override void Setup() {	
        ...
        Controller.Logic stand = Controller.AddLogic("Stand", () => false);
        ...
        Controller.Logic move = Controller.AddLogic("Move", () => true);
        ...
        Controller.Logic hold = Controller.AddLogic("Hold", () => false);
        ...
        Controller.Logic shoot = Controller.AddLogic("Shoot", () => false);
        ...
        Controller.Logic dribble = Controller.AddLogic("Dribble", () => true);
        ...
        Controller.Logic sprint = Controller.AddLogic("Sprint", () => false);

		// Controller.Logic spin = Controller.AddLogic("Spin", () => move.Query() && Controller.QueryButtonController() != 0f);
        Controller.Logic spin = Controller.AddLogic("Spin", () => false);
		...
		// );
		Controller.Logic horizontalControl = Controller.AddLogic("HorizontalControl", () => false);
		...
		// );
		Controller.Logic heightControl = Controller.AddLogic("HeightControl", () => false);
		...
		// );
		Controller.Logic speedControl = Controller.AddLogic("SpeedControl", () => false);
