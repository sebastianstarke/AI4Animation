...
class ComponentNN(object):
    def __init__(self, rng, input_x, num_experts, dim_layers, activation, weight_blend, keep_prob, batchSize, name, useBias,
                 FiLM=None):
        """
    ...
    def buildNN(self, weight_blend, FiLM):
        ...
        for i in range(self.num_layers - 1):
            ...
            if self.useBias:
                ...
                H = tf.matmul(w, H) # ?*out*in mul ?*in*1 + ?*out*1 = ?*out*1
