...
public class LogoDemo : MonoBehaviour {
	...
	void Draw() {
		...
		for(int i=0; i<5; i++) {
			UltiDraw.DrawWireSphere(new Vector3(0f, 1.5f, 0f), i*0.25f, UltiDraw.White);
		}
		
		UltiDraw.DrawSphere(new Vector3(0f, 1.5f, 0f), 2.625f, UltiDraw.Grey.Transparent(0.5f));

		UltiDraw.DrawSphere(new Vector3(0f, 1.5f, 0f), 1.95f, UltiDraw.Mustard.Transparent(0.5f));

		UltiDraw.DrawSphere(new Vector3(0f, 1.5f, 0f), 1.125f, UltiDraw.Cyan);
