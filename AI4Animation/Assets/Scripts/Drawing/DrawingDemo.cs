...
public class DrawingDemo : MonoBehaviour {
	...
	void OnDrawGizmos() {
		...
		*/
		...
		//Drawing.DrawWiredCircle(Vector3.one, 1f, Color.green, Color.black);
		//Drawing.DrawWiredCone(Vector3.one, Quaternion.identity, 1f, 1f, Color.cyan.Transparent(0.5f), Color.black);
		Drawing.DrawTranslateGizmo(Vector3.one, Quaternion.identity, 1f);
		Drawing.DrawRotateGizmo(Vector3.one, Quaternion.identity, 1f);
		Drawing.DrawScaleGizmo(Vector3.one, Quaternion.identity, 1f);
		//for(int i=0; i<1000; i++) {
