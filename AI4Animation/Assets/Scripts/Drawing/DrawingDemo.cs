...
public class DrawingDemo : MonoBehaviour {
	...
	void Draw() {
		...
		//Drawing.DrawGUIRectangle(new Vector2(0.5f, 0.2f), 0.25f, 0.1f, Color.green);

		

		//Drawing.DrawCircle(Vector3.one, Quaternion.identity, 1f, Color.red);
		//Drawing.DrawGUICircle(new Vector2(0.5f, 0.5f), 0.1f, Color.red);

		//Drawing.DrawBone(Vector3.one, Quaternion.identity, 0.25f, 1f, Color.cyan.Transparent(0.5f));
		//Drawing.DrawMesh((Mesh)Resources.Load("Meshes/Bone", typeof(Mesh)), Vector3.one + new Vector3(1f, 0f, 0f), Quaternion.identity, new Vector3(1f, 1f, 1f), Color.cyan.Transparent(0.5f));
