...
public class SlidingMeasure : MonoBehaviour {
	...
	void OnGUI() {
		...
		if(GUI.Button(Utility.GetGUIRect(0.005f, 0.90f, 0.02f, 0.02f), "X")) {
			Slidings.Clear();
		};
		GUI.Box(Utility.GetGUIRect(0.025f, 0.90f, 0.175f, 0.02f), "Average Sliding: " + Utility.ComputeMean(Slidings.ToArray()));
	}
}
