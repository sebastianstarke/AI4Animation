...
namespace UltimateIK {
    ...
    public class UltimateIK : MonoBehaviour {
        ...
        public static Model BuildModel(Model reference, Transform root, params Transform[] objectives) {
            ...
            for(int i=0; i<objectives.Length; i++) {
                Transform[] chain = Extensions.GetChain(root, objectives[i]);
                ...
                for(int j=0; j<chain.Length; j++) {
                    ...
                    if(bone == null) {
                        ...
                        if(parent != null) {
                            Extensions.Add(ref parent.Childs, skeleton.Bones.Length);
                        }
                        bone.Index = skeleton.Bones.Length;
                        Extensions.Add(ref skeleton.Bones, bone);
                    }
                    Extensions.Add(ref bone.Objectives, i);
                }
                ...
                Extensions.Add(ref skeleton.Objectives, objective);
            }
        ...
        private static Transform[] Verify(Transform root, Transform[] objectives) {
            ...
            for(int i=0; i<objectives.Length; i++) {
                ...
                } else if(!Extensions.IsInsideHierarchy(root, objectives[i])) {
                        ...
                        if(!IsConverged()) {
                            if(RootTranslationX || RootTranslationY || RootTranslationZ) {
                                ...
                                foreach(Objective o in Objectives) {
                                    if(o.IsActive()) {
                                        delta += o.Weight * (o.TargetPosition - Bones[o.Bone].Transform.position);
                                        sum += o.Weight;
                                    }
                                }
                                if(sum > 0f) {
        ...
        public class UltimateIK_Editor : Editor {
            ...
            void SetRoot(Transform t) {
                if(t == null || Target.Root == t || !Extensions.IsInsideHierarchy(Target.transform, t)) {
                    return;
                }
                Target.Root = t;
                Target.Rebuild();
            ...
            void SetObjective(int index, Transform t) {
                ...
                if(t != null) {
                    if(Target.Objectives.Contains(t) || !Extensions.IsInsideHierarchy(Target.transform, t)) {
                        return;
                    }
                }
            ...
            public override void OnInspectorGUI() {
                ...
                using(new EditorGUILayout.VerticalScope ("Box")) {
                    ...
                    using(new EditorGUILayout.VerticalScope ("Box")) {
                        ...
                        if(Extensions.GUIButton("Save", RegularButton, RegularFont, 100f, 18f)) {
                ...
                using(new EditorGUILayout.VerticalScope ("Box")) {
                    ...
                    using(new EditorGUILayout.VerticalScope ("Box")) {
                        ...
                        if(Extensions.GUIButton("Add Objective", RegularButton, RegularFont)) {
                            Extensions.Expand(ref Target.Objectives);
                            Extensions.Resize(ref Target.Targets, Target.Objectives.Length);
                        }
                        EditorGUILayout.EndHorizontal();
                    }
                }
                ...
                using(new EditorGUILayout.VerticalScope ("Box")) {
                    ...
                    if(bone.Index == Target.SelectedBone) {
                        ...
                        using(new EditorGUILayout.VerticalScope ("Box")) {
                            ...
                            bone.SetJoint((JOINT)EditorGUILayout.EnumPopup("Joint Type", bone.Joint));
                            switch(bone.Joint) {
                                case JOINT.Free:
                                break;
                        ...
                        using(new EditorGUILayout.VerticalScope ("Box")) {
                            ...
                            EditorGUILayout.LabelField("Preview Angles");
                            EditorGUILayout.BeginHorizontal();
                ...
                if(Target.Objectives[index] != null && Target.Skeleton.FindObjective(Target.Objectives[index]) != null) {
                    ...
                    using(new EditorGUILayout.VerticalScope ("Box")) {
                        ...
                        if(Extensions.GUIButton("X", InvalidField, RegularFont, 36f, 18f)) {
                            Extensions.RemoveAt(ref Target.Objectives, index);
                            Extensions.Resize(ref Target.Targets, Target.Objectives.Length);
                            Target.Rebuild();
                        } else {
                            EditorGUILayout.EndHorizontal();
            ...
            static void DrawObjective(UltimateIK ik, Objective o) {
                if(o.IsActive()) {
                    Handles.color = Color.green.Transparent(o.Weight*0.5f);
                    ...
                    Handles.color = Color.red.Transparent(o.Weight*0.75f);
