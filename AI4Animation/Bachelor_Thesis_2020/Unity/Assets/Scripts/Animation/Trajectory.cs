...
public class Trajectory {
	...
	private AnimationAuthoring AnimationAuthoring = null;
	...
	public void Draw(int step=1) {
		...
		{
			colors = AnimationAuthoring.StyleColors;
		}
		else
		{
			colors = UltiDraw.GetRainbowColors(Styles.Length);
		}
