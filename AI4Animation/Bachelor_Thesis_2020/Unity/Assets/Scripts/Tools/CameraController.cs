...
public class CameraController : MonoBehaviour {
	...
	public enum MODE {Follow, LookAt, FreeView, FixedView, SideView}
	...
	private void UpdateSideViewCamera()
	{
		Vector3 currentPosition = transform.position;
		Quaternion currentRotation = transform.rotation;

		Vector3 desiredPosition = Target.position + TargetOffset;
		Vector3 smoothedPosition = Vector3.Lerp(currentPosition, desiredPosition, 0.5f);
